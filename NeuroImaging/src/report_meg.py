import os, base64
def report_meg(top_image_paths, bottom_image_paths, output_html="report_embedded.html", 
           top_titles=None, bottom_titles=None, 
           partial_leakage=0.0,  
           p_leakage_time_min=0.0,
           p_leakage_time_max=0.0,
           p_leakage_time_avg=0.0, 
           s_leakage_time_min=0.0,
           s_leakage_time_max=0.0,
           s_leakage_time_avg=0.0,                  
           full_leakage=0.0):
    ...
    if bottom_titles is None:
        bottom_titles = [f"Bottom Image {i+1}" for i in range(1)]
    try:
